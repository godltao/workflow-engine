...
import com.greatech.workflow.dto.OperaterType;
...
/**
 * Created by bigbeard on 17-6-28.
 */
public class test {
    ...
    public void symbol() {
        Map map = new HashMap();
        map.put("大于", OperaterType.GREATER_THEN);
        map.put("小于", OperaterType.LESS_THEN);
        map.put("等于", OperaterType.EQUEL);
        map.put("包含", OperaterType.CONTAIN);
        map.put("在..里面", OperaterType.IN);
